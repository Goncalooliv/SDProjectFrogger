...
@REM ==== PC STUFF ====
@Set USERNAME=Goncalo Oliveira

@Set WORKDRIVE=C
@Set JDK="C:\\Users\\Goncalo Oliveira\\.jdks\\openjdk-15.0.2"
...
@set JAVAPROJ=%WORKDRIVE%:\\Sistemas_Distribuidos\\SD
